          ...
          <ul class="navbar-nav navbar-nav-right ml-auto">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
              ...
              if(isset($_SESSION['user'])){
                  echo '<a class="nav-link" id="UserDropdown" href="pages/samples/logout.php">Logout</a>';                                   
              }else{
                  echo '<a class="nav-link" id="UserDropdown" href="pages/samples/login.php">Login</a>'; 
              }
              ?>                         
            </li>
          </ul>
