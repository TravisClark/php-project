                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" name="frm" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail3" value="<?php echo $row[3]; ?>"name="thuongHieu">
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary mr-2" name="Luu" >Lưu</button>
